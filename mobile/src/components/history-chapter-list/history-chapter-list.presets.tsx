...
export const HistoryChapterListPresets = {
  default: "default",
};
...
export const stylePresets = {
  [HistoryChapterListPresets.default]: { ...DEFAULT_STYLE },
};

export type IHistoryChapterListPresets = keyof typeof HistoryChapterListPresets;
