...
export const FavoriteNovelListPresets = {
  default: "default",
};
...
export const stylePresets = {
  [FavoriteNovelListPresets.default]: { ...DEFAULT_STYLE },
};

export type IFavoriteNovelListPresets = keyof typeof FavoriteNovelListPresets;
