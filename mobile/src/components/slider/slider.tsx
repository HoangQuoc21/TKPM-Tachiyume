...
export const Slider = ({ minimumValue, maximumValue, value, onValueChange }) => {
  ...
  return (
    ...
    >
      ...
      <MultiSlider
        ...
        enableLabel={markerShown}
        onValuesChangeStart={() => setMarkerShown(true)}
        onValuesChangeFinish={() => setMarkerShown(false)}
      />
